...
export function AttendanceApp({ sessionExpires }: AttendanceAppProps) {
  ...
  return (
    <>
      <SessionExpiryWatcher expires={sessionExpires} hasUnsavedAttendance={Object.keys(scannedStudents).length > 0} />
